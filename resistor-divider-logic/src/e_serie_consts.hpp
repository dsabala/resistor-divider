 ...
 * Site: https://githubcom/dsabala/resistor-divider
 * License: BSD
 */
...
std::vector<std::uint64_t> GetE3Serie() {
  const std::vector<std::uint64_t> serie = {10, 22, 47};
  return serie;
}

std::vector<std::uint64_t> GetE6Serie() {
  const std::vector<std::uint64_t> serie = {10, 15, 22, 33, 47, 68};
  return serie;
}

std::vector<std::uint64_t> GetE12Serie() {
  const std::vector<std::uint64_t> serie = {10, 12, 15, 18, 22, 27,
                                            33, 39, 47, 56, 68, 82};
  return serie;
}

std::vector<std::uint64_t> GetE24Serie() {
  const std::vector<std::uint64_t> serie = {10, 11, 12, 13, 15, 16, 18, 20,
                                            22, 24, 27, 30, 33, 36, 39, 43,
                                            47, 51, 56, 62, 68, 75, 82, 91};
  return serie;
}

std::vector<std::uint64_t> GetE48Serie() {
  const std::vector<std::uint64_t> serie = {
...
std::vector<std::uint64_t> GetE96Serie() {
  const std::vector<std::uint64_t> serie = {
...
std::vector<std::uint64_t> GetE192Serie() {
  const std::vector<std::uint64_t> serie = {
...
std::vector<std::uint64_t> GetESerie(int const serie) {
  switch (serie) {
    case 3:
      return GetE3Serie();
      break;
...
std::vector<std::uint64_t> GetMultipliers() {
  const std::vector<std::uint64_t> mul = {1, 10, 100, 1000, 10000, 100000, 1000000, 10000000};
  return mul;
}